...
class Email extends BaseConfig
{
    ...
    public string $fromName   = 'BS DIGIHUB System';
    public string $recipients = '';

    public function __construct()
    {
        $this->fromEmail = env('EMAIL_FROM', 'noreply@bsdigihub.com');
        $this->fromName = env('EMAIL_FROM_NAME', 'BS DIGIHUB System');
        $this->recipients = env('EMAIL_RECIPIENTS', '');
        
        // Configure SMTP if environment variables are set
        if (env('EMAIL_PROTOCOL')) {
